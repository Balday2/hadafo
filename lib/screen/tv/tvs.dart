  ...
  Widget build(BuildContext context) {
    return Obx(() => Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: false,
        title: "Les directs".text.xl3.color(Helpers.theme() ? Vx.gray200 : Vx.gray700).fontFamily('FredokaOne').make().pOnly(left:10),
      ),
  ...
  Widget _tvUi(TvData tv){
    return Stack(
      children: [
        ...
        ).withRounded(value:10.0).size(Get.width, Get.width/1.8).make(),
        ...
        ).withRounded(value:10.0).size(Get.width, Get.width/1.8)
